...
% \section{Kiểm định Anova 2 nhân tố:}
% \textbf{Đặt đề}\\
% Có nhiều khách hàng cho rằng các dòng sản phẩm ở từng phân khúc ứng dụng sẽ có số lõi khác nhau, vì thế thực hiện kiểm định Anova để kiểm tra có liên hệ giữa các dòng sản phẩm (\textit{Product\_Collection}) và phân khúc ứng dụng (\textit{Vertical\_Segment}) đến số lõi CPU (\textit{nb\_of\_Cores}) hay không. \\
% \textbf{Tóm tắt dữ liệu}
% \begin{figure}[h!]
%  \begin{left}
%   \includegraphics[width=14cm]{1.png}
%  \end{left}
% \end{figure}
% \subsection{Kiểm tra giả thuyết Anova:}
% Kiểm tra giả thuyết Anova:\\
